...
//                if (isset($_POST['save'])) {
//                    $save = $_POST['save'];
//                $this->redirect(array('view', 'id' => $model->id,'save'=>$save));
//                    $Use_Title = 1;
//                    $now_date = DATE('m-d-Y H:i');
////                    $title = "Dump For Table $DB_TBLName from Database $DB_DBName on $now_date";
//                    $file_type = "msword";
//                    $file_ending = "doc"; //sua cho nay 
                //header info for browser: determines file type ('.doc' or '.xls')
//                    for ($j = 0; $j < ($noEasy + $noMedium + $noHard); $j++) {
//                        print"Pham Thi Thu Thuy";
//                        print"\n------------------------------------------------------\n";
//                    }
//                }
                if (isset($_POST['save'])) {
                    //$this->redirect(array('download'));
                    $this->redirect(array('preview', 'id' => $model->id, 'save' => $_POST['save'], 'subject' => $subjectId));
                } else {
...
//        $time = $rs[0];
        if (isset($_POST['generate'])) {
            $html = $_POST['html'];
            $this->redirect(array('download', 'html' => $html));
        }
    ...
    public function actionsExportToFile() {
        $model = new Exam;
        $this->render('exportToFile', array('model' => $model));
    }
